                ...
                <body>
                    ...
                    <form id="form" name="form"  action = 'MATERIA_Controller.php'  method = 'post' enctype="multipart/form-data"><br>
                        <ul class="form-style-1">
                            <?php
                            createForm($lista, $DefForm, $strings, $this->valores, array('MATERIA_NOM'=>true, 'MATERIA_CREDITOS'=>true, 'MATERIA_DEPARTAMENTO'=>true, 'MATERIA_TITULACION'=>true,'MATERIA_DESCRIPCION'=>false), array('MATERIA_ID'=>true));
                            ?>
