...
class CORRECCION_Rubrica{
//VISTA PARA LISTAR TODAS LAS RUBRICAS
	private $datos;
	private $ENTREGA_ID;
	private $volver;

	function __construct($ENTREGA_ID,$array, $volver){
	...
	function render(){
		...
		<div class="wrap">
			...
			<div class="container">
				...
				$lista = array('RUBRICA_ID','RUBRICA_NOMBRE','RUBRICA_AUTOR');
				...
				<div id="centrado"><table class="table" id="btable" border = 1>
						...
						for ($j=0;$j<count($this->datos);$j++){
							...
							<td>
								<a href='CORRECCIONES_Controller.php?RUBRICA_ID=<?php echo $this->datos[$j]['RUBRICA_ID'] .'&ENTREGA_ID='.$this->ENTREGA_ID.'&accion='.$strings['Insertar']; ?>'><?php echo $strings['Insertar'] ?></a>
							</td>
