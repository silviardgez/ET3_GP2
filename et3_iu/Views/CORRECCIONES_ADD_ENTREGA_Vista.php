...
class CORRECCION_Entrega{
//VISTA PARA LISTAR TODAS LAS ENTREGAS
	private $datos;
	private $volver;
			...
			<div class="container">
				...
				<div id="centrado"><table class="table" id="btable" border = 1>
						...
						for ($j=0;$j<count($this->datos);$j++){
							...
							<td>
								<a href='CORRECCIONES_Controller.php?ENTREGA_ID=<?php echo $this->datos[$j]['ENTREGA_ID'] . '&accion='.$strings['Insertar']; ?>'><?php echo $strings['Insertar'] ?></a>
							</td>
