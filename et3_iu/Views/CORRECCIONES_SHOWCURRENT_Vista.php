...
foreach ($this->datos[$j] as $clave => $valor) {
	for ($i = 0; $i < count($lista); $i++) {
		...
		<td>
			<a href='CORRECCIONES_Controller.php?CORRECCION_NOM=<?php echo $this->datos[$j]['CORRECCION_NOM'] . '&accion='.$strings['Modificar']; ?>'><?php echo $strings['Modificar'] ?></a>
		</td>
		<td>
			 <a href='CORRECCIONES_Controller.php?CORRECCION_NOM=<?php echo $this->datos[$j]['CORRECCION_NOM'] . '&accion='.$strings['Borrar']; ?>'><?php echo $strings['Borrar'] ?></a>
		</td>
		</tr>
