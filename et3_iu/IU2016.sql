DROP DATABASE IF EXISTS `ET3Grupo2`;
CREATE DATABASE IF NOT EXISTS `ET3Grupo2` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `ET3Grupo2`;
CREATE USER 'ET3Grupo2'@'localhost' IDENTIFIED BY 'ET3Grupo2';
GRANT ALL PRIVILEGES ON * . * TO 'ET3Grupo2'@'localhost';
FLUSH PRIVILEGES;
...
`DOCUMENTACION_ID` int(10) NOT NULL,
...
`DOCUMENTACION_ENLACE` varchar(150) COLLATE utf8_spanish_ci NOT NULL,
...
(1, 'Definicion ET3', '65938568Y', 1, '2016-12-10 00:00:00', '../Documents/Documentacion/Definicion_ET3.pdf','Teoria'),
